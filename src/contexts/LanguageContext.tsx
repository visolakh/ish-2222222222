...
const translations = {
  ru: {
    ...
    'jobs.latest.russia.job3': 'Машинист мостового крана (с пола)',
    'jobs.latest.russia.job4': 'Пультовый оператор',
    ...
    'jobs.latest.russia.job10': 'Водитель погрузчика (вилочного)',
    'jobs.latest.russia.job11': 'Водитель электрокара',
    'jobs.latest.russia.job12': 'Инженер по контролю сосудов под давлением (2 места)',
    'jobs.latest.russia.job13': 'Инженер КИПиА',
    'jobs.latest.russia.job14': 'Механик по грузоподъёмным механизмам',
    'jobs.latest.russia.job15': 'Инженер по контролю грузоподъёмных механизмов',
    'jobs.latest.russia.job16': 'Инженер ОТК',
    'jobs.latest.russia.job17': 'Инженер-эколог',
    'jobs.latest.russia.job18': 'Инженер ОТК',
    'jobs.latest.russia.job19': 'Инженер-эколог',
    'jobs.latest.croatia.title': 'Хорватия',
    'jobs.latest.croatia.job1': 'Строитель общего профиля',
    'jobs.latest.croatia.job2': 'Штукатуры',
    'jobs.latest.croatia.job3': 'Маляры',
    'jobs.latest.israel.title': 'Израиль',
    'jobs.latest.israel.job1': 'Водители грузовиков',
    'jobs.latest.israel.job2': 'Горничные',
    'jobs.latest.israel.job3': 'Уборщицы',
    'jobs.latest.israel.job4': 'Официанты',
    'jobs.latest.israel.job5': 'Сборщики мебели и столяры (фабрика)',
    'jobs.latest.israel.job6': 'Монтажник алюминиевых композитных панелей',
    'jobs.latest.israel.job7': 'Монолитчик по технологии Бернович',
    'jobs.latest.germany.title': 'Германия',
    'jobs.latest.germany.job1': 'Водители категории СЕ',
