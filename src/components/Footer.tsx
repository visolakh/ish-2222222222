          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-start gap-2 sm:gap-3 text-white/80 text-sm sm:text-[15px]">
                ...
                <a href="https://www.horizon-work.uz" target="_blank" rel="noopener noreferrer" className="break-words hover:text-[#FFD347] transition-colors">www.horizon-work.uz</a>
              </li>
              <li className="flex items-start gap-2 sm:gap-3 text-white/80 text-sm sm:text-[15px]">
